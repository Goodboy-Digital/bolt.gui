...
import { addPanelReducer, clearPanelReducer, removePanelReducer, setActivePanelReducer } from './panelReducers';
...
const componentReducers = (store = initialStore, action: Actions): ReduxStore =>
{
    switch (action.type)
    {
        ...
        case ActionTypes.CLEAR_PANEL: return clearPanelReducer(store, action);
        case ActionTypes.SET_ACTIVE_PANEL: return setActivePanelReducer(store, action);
